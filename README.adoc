...
The credentials should be placed in `client-id` and `client-secret` within link:src/main/resources/application.yml[src/main/resources/application-local.yml] which is setup to be ignored so you don't accidentally commit your credentials.
...
The token should be placed in `personal-access-token` within link:src/main/resources/application.yml[src/main/resources/application-local.yml] which is setup to be ignored so you don't accidentally commit your credentials.
...
The secret should be placed in `webhook-secret` within link:src/main/resources/application.yml[src/main/resources/application-local.yml] which is setup to be ignored so you don't accidentally commit your credentials.
